...
mode = int(input())
if mode == 1:
    model = coremltools.models.MLModel("illigulThings.mlmodel")
...
while True:
    ...
    predictedclass = out_dict.get("classLabel")
    print("Predicted device is " + predictedclass)
    print("Accuracy : " + str(prediction.get(predictedclass)))
...
#        print("Knif")
#        print(predKnif)
#    elif preGuns > predKnif and predKnif > preDrinks:
#        print("GUNS")
#        print(preGuns)
